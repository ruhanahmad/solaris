  ...
  Widget build(BuildContext context) {
   ...
   StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        List<String> names = documents.map((doc) => doc['name'] ).toList() as List<String>;
        ...
        return DropdownButton<String>(
          ...
          items: names.map<DropdownMenuItem<String>>((String value) {
            ...
            if (selectedDoc != null) {
              String selectedUserId = selectedDoc['userId'] as String;
              String selectedEmail = selectedDoc['email'] as String;
