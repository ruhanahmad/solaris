...
class CustomerProcedure extends StatefulWidget {

  String? id;
  String? name;
  CustomerProcedure({required this.id,required this.name});
  @override
  State<CustomerProcedure> createState() => _CustomerProcedureState();
}

class _CustomerProcedureState extends State<CustomerProcedure> {
