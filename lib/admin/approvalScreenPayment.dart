...
// class ApprovalScreenPayment extends StatefulWidget {
//     String? id;
//   String? name;
//   ApprovalScreenPayment({required this.id,required this.name});
//   @override
//   State<ApprovalScreenPayment> createState() => _ApprovalScreenPaymentState();
// }

// class _ApprovalScreenPaymentState extends State<ApprovalScreenPayment> {
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Approval Recieved Payment'),
...
//                                         ElevatedButton(
//                         onPressed: () async{
//                         await   sentForApproval == false  ?   adminController.generateAndUploadPdf(netMeteringOfficerName,description,payment,customerName,widget.id!,ids):Get.snackbar("Sent", "Already sent for approval")
//            ;       
